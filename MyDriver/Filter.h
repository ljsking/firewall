...
#define DEL_RULE CTL_CODE(FILE_DEVICE_DRVFLTIP, DRVFLTIP_IOCTL_INDEX+8, METHOD_BUFFERED, FILE_READ_ACCESS)
#define DEL_WORD CTL_CODE(FILE_DEVICE_DRVFLTIP, DRVFLTIP_IOCTL_INDEX+9, METHOD_BUFFERED, FILE_READ_ACCESS)
#define DEL_PORT CTL_CODE(FILE_DEVICE_DRVFLTIP, DRVFLTIP_IOCTL_INDEX+10, METHOD_BUFFERED, FILE_READ_ACCESS)
